 ...
 * @returns {URI} A new valid and fro moonroomcash instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'moonroomcash:') {
    throw new TypeError('Invalid moonroomcash URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid moonroomcash address');
  }
